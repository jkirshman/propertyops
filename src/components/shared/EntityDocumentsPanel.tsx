...
/** Generic documents tab for any registered `RELATED_ENTITY_FILE_RULES` entity type. */
  ...
  const load = useCallback(async () => {
    try {
      const response = await fetch(
        `/api/files?relatedEntityType=${relatedEntityType}&relatedEntityId=${relatedEntityId}`,
      );
      if (response.ok) {

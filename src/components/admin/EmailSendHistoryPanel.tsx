...
// Friendly names for known kinds; anything else (e.g. notification.*) shows its raw kind.
const KIND_LABELS: Record<string, string> = {
  test: "Test",
  user_invitation: "Account invitation",
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem", alignItems: "flex-end" }}>
        ...
        <div>
          ...
          <input
            ...
            className="input"
            placeholder="e.g. user_invitation, password_reset"
            value={kind}
            ...
            <tbody>
              {attempts.map((attempt) => (
                <tr key={attempt.id} style={{ borderBottom: "1px solid var(--border)" }}>
                  ...
                  <td style={{ padding: "0.5rem 0" }} title={attempt.kind}>{KIND_LABELS[attempt.kind] ?? attempt.kind}</td>
